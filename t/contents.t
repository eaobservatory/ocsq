...
# INSERTQ
print "# INSERTQ\n";
$q->insertq(2, new Queue::Entry("entry10"), new Queue::Entry("entry11"));
is($q->curindex(), 4, "check index");
is($q->countq, 5, "check count");
$q->insertq(2, new Queue::Entry("entry12"), new Queue::Entry("entry13"));
is($q->curindex(), 6, "check index");
is($q->countq, 7, "check count");
$q->curindex(3);
$q->insertq(4, new Queue::Entry("entry12"), new Queue::Entry("entry13"));
is($q->curindex(), 3, "check index");
is($q->countq, 9, "check count");

$q->insertq(36, new Queue::Entry("entry12"), new Queue::Entry("entry13"));
is($q->curindex(), 3, "check index");
is($q->countq, 11, "check count");

$q->insertq(-22, new Queue::Entry("entry12"), new Queue::Entry("entry13"));
...
$q->insertq(4, new Queue::Entry("entry14"), new Queue::Entry("entry15"));
is($q->curindex, 0, "check index");
